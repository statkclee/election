...
# 공약이행평가 데이터 {#manifest-data-congressman}

앞서 제20대 국회의원 매니페스토 대상 목록을 파악했기 때문에 이를 바탕으로 공약이행자체평가표(2020년)를 다운로드 받는다.   

![매니페스토 데이터 추출 자동화](fig/manifesto-automation.png)

## 데이터 가져오기 {#manifest-data-congressman-download}
...
![매니페스토 자료구조](fig/manifesto-data.png)

## 데이터 압축풀기 [^extract-7za] {#manifest-data-congressman-unzip}
...
## PDF 파일변환 {#manifest-data-congressman-convert}
